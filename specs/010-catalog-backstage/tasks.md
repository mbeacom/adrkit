...
- [X] T093 [US9] Verify from a **clean clone** that build, typecheck, lint, and
      ...
      **Second conjunct:** no post-install step requires or uses the network. **16 of the
      17 post-install steps additionally prove it under a denial**; the 17th is `bun test`,

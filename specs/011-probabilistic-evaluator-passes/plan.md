...
its binding open questions **Q3–Q6** (Q1, Q2, Q7 and Q8 resolved during scoping).
...
├── spec.md                         # Feature spec (binding; FR-001–FR-029, SC-001–SC-017, Q3–Q6 open)
├── plan.md                         # This file
...
Four questions are unresolved by design and are reproduced from [spec.md](./spec.md) so this plan
cannot be read as settled. **Q3 blocks `novel-no-precedent`; Q4–Q6 block their surfaces.** Q1, Q2, Q7 and Q8 are resolved during scoping — 012 froze the confidence aggregate, the contradiction predicate, the calibration vocabulary, and the shipped-pass detector.

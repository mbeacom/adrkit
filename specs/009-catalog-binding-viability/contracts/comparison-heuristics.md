...
**This is explicitly labeled a proxy, never external-adopter maturity
...
external / community validation (ADR-0014 rung 3) or optional externally-validated maturity.

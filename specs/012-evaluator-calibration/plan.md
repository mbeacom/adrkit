...
| A probabilistic pass ships and the registry is simply not updated | FR-013's two-source cross-check fails on the **observable pass surface** the registry does not declare. |

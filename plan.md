...
| Catalog (Backstage) | not built | Viability spike `specs/009-catalog-binding-viability/` recorded `blocked`; see the Phase 8 row above. No `packages/adapters/catalog-*/**` exists. |

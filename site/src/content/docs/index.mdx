...
<div class="adr-home">
	<section class="adr-status-band" aria-label="Project status">
		<div class="adr-status-band__item">
			<span class="adr-status adr-status--current">Published · v0.2.0</span>
			<p>
		...
		<div class="adr-status-band__item">
			...
			<p>
				Evaluator Passes 1–3 and catalog binding are not built, and
				ADR-0014 rung-3 external validation is still open.
			</p>
		</div>
	</section>
	...
	<section class="adr-home__section adr-flow" aria-labelledby="one-field">
		...
		<ol class="adr-flow__steps">
			...
			<li>
				...
				<p>
					<code>adr explain</code> prints it, the CI Action comments it on
					the pull request that touches it, and the MCP server hands it to an
					agent before it drafts a plan.
				</p>
			</li>
		</ol>
	</section>
	...
	<section class="adr-home__section adr-roadmap" aria-labelledby="roadmap">
		...
		<ul class="adr-roadmap__list">
			<li class="adr-roadmap__item">
				...
				<p>
					The <code>packages/ci</code> Action comments the accepted decisions
					governing touched files, read-only, on the default token.
				</p>
			</li>
			<li class="adr-roadmap__item">
				<span class="adr-status adr-status--current">Works today</span>
				...
				<p>
					The <code>@adrkit/mcp</code> server exposes accepted <em>and</em>
					rejected decisions over stdio, so a new plan does not repeat an old
					argument.
				</p>
			</li>
			<li class="adr-roadmap__item">
				...
				<p>
					<code>adr evaluate</code> runs the model-free Pass 0 rubric and
					routes to a named human — it never approves.
				</p>
			</li>
			<li class="adr-roadmap__item">
				...
				<p>
					Only the deterministic Pass 0 is built. The later probabilistic
					passes are not.
				</p>
			</li>
			<li class="adr-roadmap__item">
				...
				<p>
					Resolving decisions against a service catalog is recorded as blocked
					pending a viability spike.
				</p>
			</li>
			<li class="adr-roadmap__item">

...
- **Spec Kit `>=0.13.0,<1.1.0`.** Compatibility is tested against 0.13.0,
  0.14.4, 0.15.1, 0.16.5, 1.0.0, and 1.0.4–1.0.6.
...
tested against Spec Kit 0.13.0, 0.14.4, 0.15.1, 0.16.5, 1.0.0, and 1.0.4–1.0.6. If
you find a compatibility issue, [open an issue](https://github.com/mbeacom/adrkit/issues).

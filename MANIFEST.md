...
`0000-template.md`: 35 accepted, 2 proposed, 2 superseded.
...
| `0039` | proposed | Derive a valid-time window from date and supersession, and resolve a git ref at the CLI boundary |

...
There are 40 records, ids `0001`-`0040`, alongside
`0000-template.md`: 37 accepted, 1 proposed, 2 superseded.
...
| `0037` | accepted | Treat generated knowledge systems as downstream read models, not decision authorities |
| `0038` | accepted | Offer the bootstrap decision record as an offer rather than a backfill candidate |
| `0039` | accepted | Derive a valid-time window from date and supersession, and resolve a git ref at the CLI boundary |
| `0040` | proposed | Keep derived surfaces in lockstep with three mechanisms matched to three classes of drift |
